...
if(isset($_GET['login'])) {
    // Ambil dan bersihkan nilai email dan password dari parameter URL
    $email = mysqli_real_escape_string($conn, $_GET['email']);
    $password = mysqli_real_escape_string($conn, $_GET['password']);
    
    // Query untuk mendapatkan data pengguna beserta levelnya
...
<head>
    ...
    <meta name="viewport" content="width=dev  m">
    </script>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="GET">
                    ...
                    <button type="submit" name="login"
                        ...
                        onclick="">Login to your account</button>
